...
const games = [
  {
    ...
    image:
      "https://assets.ltkcontent.com/images/89993/spelling-word-game_7abbbb2796.jpg",
  },
  {
    title: "Grammar Game",
    description: "Learn basic grammar concepts.",
    image:
      "https://www.plazoom.com/images/made/assets/resources/GG-Tile_(1)_700_700_c1.png",
  },
  {
  ...
  },
  {
    ...
    image:
      "https://img.freepik.com/premium-photo/middle-age-greyhaired-man-wearing-casual-clothes-smiling-with-hand-ear-listening-hearing_660230-33133.jpg?semt=ais_hybrid&w=740&q=80",
  },
];
...
const GameCardGrid = () => {
  return (
    <div>
      {/* <Header /> */}
      <div className="relative  py-16 px-4 sm:px-8 lg:px-16 overflow-hidden my-10 mx-2 rounded-[50px]">
        {/* Decorative boat bg */}
        ...
        {/* Dog */}
        <div className="absolute bottom-0 right-10 w-[190px] h-[190px] md:w-[250px] md:h-[250px] bg-cover bg-[url('https://cdn.pixabay.com/animation/2024/10/18/13/57/13-57-40-141_512.gif')] bg-repeat-x z-100" />

        {/* Heading + GIF Section */}
        <div className="relative z-10  mx-auto max-w-5xl flex flex-col  items-center justify-center gap-6 text-center sm:text-left mb-10">
          <div className=" bg-white/80 backdrop-blur-md flex flex-col items-center rounded-3xl p-6 sm:p-8 shadow-lg">
            {/* GIF */}
